...
public abstract class FluidMud extends FlowingFluid {
	...
	protected BlockState getBlockState(IFluidState state) {
		return BlockInit.mud.get().getDefaultState().with(FlowingFluidBlock.LEVEL, Integer.valueOf(getLevelFromState(state)));
	}
	
	@Override
	public boolean isEquivalentTo(Fluid fluidIn) {
		return fluidIn == FluidInit.MUD || fluidIn == FluidInit.FLOWING_MUD;
	}
	
	@Override
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation(ExpandedMod.MOD_ID, "blocks/mud_still"), new ResourceLocation(ExpandedMod.MOD_ID, "blocks/mud_flow"))
				.translationKey("block.expandedmod.mud")
				.build(this);
	}
